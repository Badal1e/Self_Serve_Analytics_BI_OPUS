...
@Component({
  ...
  styles: [
    `
      ...
      .role-badge { background: #eff6ff; color: #2563eb; padding: 1px 7px; border-radius: 10px; font-weight: 600; font-size: 0.72rem; }
      ...
      .session-row:hover { background: #eff6ff; }
      ...
      .btn-open { background: transparent; border: 1px solid #93c5fd; color: #2563eb; border-radius: 5px; padding: 3px 10px; font-size: 0.75rem; cursor: pointer; font-weight: 500; transition: all 0.15s; }
      .btn-open:hover { background: #2563eb; color: white; }
